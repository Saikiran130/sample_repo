...
public class student {
	...
	public static void main(String[] args) {
		...
		student s1=new student("Harry",20,'A','M',80,80,75);
	    student s2=new student("Janu",22,'B','F',67,87);
	    student s3=new student("Sai",21,'C','M',45,67);
	    student s4=new student("John",25,'D','M',70,77,68);
	    s1.dislay();
	    System.out.println("------------------------------------");
	    s2.dislay();
	    System.out.println("------------------------------------");
